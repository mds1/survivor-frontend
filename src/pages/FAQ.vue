<template>
  ...
  <div class="layout-padding">
    ...
    source of some questions: https://medium.com/@lyricalpolymath/web3-design-principles-f21db2f240c1

    - What is Ethereum and the blockchain? - link to MyCrypto KnowledgeBase
