<template>
<!-- This file is modified from: https://github.com/getanwar/vuejs-countdown -->
  <div>
      ...
      <p>Picks must be made by {{localDate}}</p>
    </div>
</template>
...
export default {
  ...
  created() {
    ...
    this.localDate = date.formatDate(this.deadline, 'dddd MMMM DD YYYY H:mm Z');
